...
class Traveler {
    ...
    static addStructuresToMatrix(room, matrix, roadCost) {
        for (let structure of room.cacheFind(FIND_STRUCTURES)) {
        ...
        for (let site of room.cacheFind(FIND_CONSTRUCTION_SITES)) {
    ...
    static addCreepsToMatrix(room, matrix) {
        room.cacheFind(FIND_CREEPS).forEach((creep) => matrix.set(creep.pos.x, creep.pos.y, 0xff));
        return matrix;
    }
